...
- Generate individuals for multiple species under realistic **species–abundance distributions** (e.g., Fisher’s log-series, neutral ZSM).
- Impose **environmental filtering** (per‑species optima/tolerances on named gradients).
- Add **spatial structure** using canonical point processes (Poisson, Thomas, and fast MCMC-based Strauss/Geyer models) or an optional neutral simulation engine with dispersal limitation.
...
You can specify interspecific effects **inline in the init file** or via a simple **CSV edgelist** (neighbour effects). See the dedicated vignette:
