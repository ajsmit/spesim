...
| [`plot_spatial_sampling()`](https://ajsmit.github.io/spesim/reference/plot_spatial_sampling.md)                             | Publication‑ready map of domain, individuals, quadrats, optional gradient fill.                  |
| [`generate_full_report()`](https://ajsmit.github.io/spesim/reference/generate_full_report.md)                               | Text report covering gradients, distributions, diversity, and Fisher log‑series validation.      |
| [`generate_advanced_panel()`](https://ajsmit.github.io/spesim/reference/generate_advanced_panel.md)                         | Patchwork panel: rank–abundance, occupancy–abundance, species–area, distance–decay, rarefaction. |
