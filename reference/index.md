...
- [`generate_advanced_panel()`](https://ajsmit.github.io/spesim/reference/generate_advanced_panel.md)
  : Advanced Analysis Panel (rank/occupancy/SAR/decay/rarefaction +
  optional PPC)
...
- [`generate_heterogeneous_distribution()`](https://ajsmit.github.io/spesim/reference/generate_heterogeneous_distribution.md)
  : Generate a heterogeneous community (point process + environment +
  interactions)
...
- [`rthomas_fast()`](https://ajsmit.github.io/spesim/reference/rthomas_fast.md)
...
- [`simulate_points_geyer_fast()`](https://ajsmit.github.io/spesim/reference/simulate_points_geyer_fast.md)
