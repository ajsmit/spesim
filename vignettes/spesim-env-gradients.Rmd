...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Simulating Environmental Gradients with spesim}
...
For method testing, it’s useful to visualise whether gradient-responsive species
show higher quadrat abundances near their configured optimum.

```r
# using a results object from spesim_run() (preferred) or run_spatial_simulation() (legacy)
