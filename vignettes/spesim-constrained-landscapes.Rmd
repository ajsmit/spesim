...
P0 <- load_config(system.file("examples/spesim_init_basic.txt", package = "spesim"))
P0$N_SPECIES <- 12
...
## Scenario B: network-style constrained landscape (Doubs-like)
...
P_net$ENV_COVARIATES_FILE <- system.file("extdata/doubs_like_nodes.csv", package = "spesim")

case_net <- run_case(P_net, "Network-like constrained landscape (linearized)")
case_net$map
```

## Scenario C: coastline-style constrained landscape with directional dispersal
...
P_coast$ENV_COVARIATES_FILE <- system.file("extdata/seaweed_coast_sections.csv", package = "spesim")

case_coast <- run_case(P_coast, "Coastline-like constrained landscape (directional dispersal)")
case_coast$map
```
