...
- For Doubs-style/seaweed-style constrained gradients, set
  `DOMAIN_TYPE = "network"` or `"coastline"` and use `DISTANCE_METRIC = "along_path"`.
- You can replace synthetic raster fields by supplying `ENV_COVARIATES_FILE`
  (section/node-level covariates with `x,y` plus environmental columns).
